    ...
    <div className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-lg text-start lg:py-16">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          As an ambitious HR consultancy with a drive to become the 'HR Partner
          of Choice', we offer a wide variety of services thatt help you
          increase employee motivation and performance, which in turn ccreates a
          more profitable business. Our flexible support options are designed to
          help clients scale to their full potential and are offered on a
          retained, project or ad-hoc basis.
        </p>
      </div>
    </div>
  );
