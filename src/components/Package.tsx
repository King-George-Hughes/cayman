...
const Package = ({ id, title, subText, price, includedFeatures }: Props) => {
  return (
      ...
      {id % 2 === 0 ? (
        <>
          ...
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-[#dacb46]">
              {title} Package
            </h3>
            ...
            <div className="mt-10 flex items-center gap-x-4">
              <h4 className="flex-none text-sm font-semibold leading-6 text-[#dacb46]">
                What’s included
              </h4>
            ...
            >
              {includedFeatures.map((feature) => (
                <li key={feature} className="flex gap-x-3">
                  <CheckIcon
                    className="h-6 w-5 flex-none text-[#dacb46]"
                    aria-hidden="true"
                  />
                  {feature}
                </li>
