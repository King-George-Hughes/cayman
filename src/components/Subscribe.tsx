      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20">
        <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl text-gray-800 font-bold lg:text-4xl lg:leading-tight dark:text-gray-200">
              Get all the latest{" "}
              <span className="bg-clip-text bg-gradient-to-tl from-primaryColor to-primaryColor2 text-transparent">
                Cayman Ghana Ltd updates and news
              </span>
            </h1>
          </div>
          ...
          <form onSubmit={(event) => event.preventDefault()}>
            <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2]">
              ...
              <div className="pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto]">
                <button className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primaryColor text-gray-700 hover:bg-primaryColor2 focus:outline-none focus:ring-2 focus:ring-primaryColor2 focus:ring-offset-2 transition-all text-sm sm:p-4">
                  Subscribe
                </button>
              </div>
            </div>
