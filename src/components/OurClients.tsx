      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-7 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-8">
          ...
          <img
            ...
            src="images/clients/rijalco.jpeg"
            alt="Reform"
            width={158}
            height={48}
          />
          ...
          <img
            ...
            src="images/clients/property.jpeg"
            alt="Statamic"
            width={158}
            height={48}
          />
          ...
          <img
            className="col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1"
            src="images/clients/st jude.jpeg"
            alt="Statamic"
            width={158}
            height={48}
          />
